...
# 4. ESTILOS CSS DINÁMICOS
if not st.session_state.entrado:
    # Solo mostramos el botón gigante si NO hemos entrado
    st.markdown("""
    <style>
        .portada {
    ...
    # Si ya entramos, aplicamos estilos normales de botones
    st.markdown("""
    <style>
    ...
    # Botón WhatsApp Real (Aislado para que funcione)
    st.markdown('<a href="https://wa.me/56992238085" target="_blank" style="background-color:#25D366;color:white;padding:15px;border-radius:10px;text-decoration:none;display:block;text-align:center;font-weight:bold;margin-bottom:20px; position:relative; z-index:10;">📲 HABLAR CON PAPI REAL</a>', unsafe_allow_html=True)
